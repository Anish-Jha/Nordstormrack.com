...
let prod = [
  ...
  let container = document.getElementById("best_seller_prod");
  ...
  let append = (prod) => {
    ...
    prod.forEach((el, idx) => {
      ...
      card.setAttribute("class", "women-card-div");
      ...
      img2.setAttribute("class", "women-card-image-2");
      img2.src = el.image2;
      ...
      div2.append(img2);
      card.append(div1, name1, des1, price1);
